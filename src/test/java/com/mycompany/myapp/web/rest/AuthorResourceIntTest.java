...
import com.mycompany.myapp.JdLdemoApp;
...
public class AuthorResourceIntTest {
    ...
    private static final String DEFAULT_WRITER_BOOK = "AAAAAAAAAA";
    private static final String UPDATED_WRITER_BOOK = "BBBBBBBBBB";
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author()
            ...
            .writerBook(DEFAULT_WRITER_BOOK);
        return author;
    }
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getWriterName()).isEqualTo(DEFAULT_WRITER_NAME);
        assertThat(testAuthor.getWriterBook()).isEqualTo(DEFAULT_WRITER_BOOK);
    }
    ...
    public void getAllAuthors() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].writerName").value(hasItem(DEFAULT_WRITER_NAME.toString())))
            .andExpect(jsonPath("$.[*].writerBook").value(hasItem(DEFAULT_WRITER_BOOK.toString())));
    }
    ...
    public void getAuthor() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors/{id}", author.getId()))
            ...
            .andExpect(jsonPath("$.writerName").value(DEFAULT_WRITER_NAME.toString()))
            .andExpect(jsonPath("$.writerBook").value(DEFAULT_WRITER_BOOK.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateAuthor() throws Exception {
        ...
        updatedAuthor
            ...
            .writerBook(UPDATED_WRITER_BOOK);
        ...
        Author testAuthor = authorList.get(authorList.size() - 1);
        assertThat(testAuthor.getWriterName()).isEqualTo(UPDATED_WRITER_NAME);
        assertThat(testAuthor.getWriterBook()).isEqualTo(UPDATED_WRITER_BOOK);
    }
